 ...
 * @author Nipuna
 */
public class EditLocationsRooms extends javax.swing.JFrame {
    ...
    public EditLocationsRooms() {
        initComponents();
    }

    EditLocationsRooms(String selectedid, String buildingid, String buidingname) {
        this();
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 30, -1, -1));
        ...
        getContentPane().add(jTextField3, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 320, 210, 40));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 460, 210, 40));

        jComboBox1.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "None", "Server Room", "Lecture Room" }));
        getContentPane().add(jComboBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 390, 210, 40));

        jLabel9.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 2, true));
        getContentPane().add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 260, 530, 260));

        jLabel10.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 2, true));
        getContentPane().add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 10, 530, 230));

        setSize(new java.awt.Dimension(619, 589));
        ...
        try {
            ...
            if (jTextField3.getText().equals("") || jComboBox1.getSelectedItem().toString().equals("None")) {
                ...
                if (rs.next()) {
                    ...
                    DBNEW.closeConn();
                    DBNEW.createCon();
                    DBNEW.iud("update rooms set roomid='" + jTextField3.getText() + "',roomtype='" + jComboBox1.getSelectedItem().toString() + "' where id='" + id + "'");
                    DBNEW.closeConn();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditLocationsRooms.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditLocationsRooms().setVisible(true);
            }
        });
    }
