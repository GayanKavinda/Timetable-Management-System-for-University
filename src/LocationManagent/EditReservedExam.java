 ...
 * @author Nipuna
 */
public class EditReservedExam extends javax.swing.JFrame {
    ...
    public EditReservedExam() {
        initComponents();
    }

    EditReservedExam(String buildingid, String roomid, String roomtype, String date, String timefrom, String timeto, String id) {
        this();
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 450, -1, -1));
        ...
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 240, -1, 20));
        ...
        getContentPane().add(jTextField3, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 230, 290, 40));
        ...
        getContentPane().add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 300, -1, 20));
        getContentPane().add(jTextField6, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 290, 290, 40));

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel2.setText("Update Exam Details");
        ...
        getContentPane().add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 210, 570, 290));

        jLabel11.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 2, true));
        getContentPane().add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 40, 570, 150));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            ...
            if (jTextField6.getText().equals("") || jTextField4.getText().equals("") || jTextField1.getText().equals("") || jTextField3.getText().equals("")) {
                ...
                if (showConfirmDialog == 0) {
                    ...
                    DBNEW.closeConn();
                    DBNEW.createCon();
                    DBNEW.iud("update reserveroomforstudy set date='" + jTextField6.getText() + "',timefrom='" + jTextField4.getText() + "',subject='" + jTextField1.getText() + "',studentid='" + jTextField3.getText() + "' where id ='" + id + "'");
                    DBNEW.closeConn();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditReservedExam.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditReservedExam().setVisible(true);
            }
        });
    }
